...
const Home: NextPage = () => {
  return (
    <div className="flex flex-col bg-cover bg-center md:bg-fixed" style={{backgroundImage:("url(/bg.png)")}}>
      <Head>
      ...
      <main className='lg:max-w-screen-2xl md:px-20 ms:px-5 mx-auto'>
        <div>
          ...
          <SpritViewImg imgSrc='/00.png' title={title01} description={description01} isRight={true}/>
          ...
          <section>
            <div className="grid lg:grid-cols-2 gap-6 m-5">
              <CollectionTwice title='マイクラ花火師入門（8月公開予定）' category='Document' imgSrc='/dummy.png' href='#'/>
              <CollectionTwice title='花火のレシピノート' category='Code' imgSrc='/cat.png' href='https://zenn.dev/takunology/scraps/9462b03d13dd0a'/>
            </div>
          </section>
        </div>
      </main>
